...
public class Act2 {
	...
	System.out.println("los pares son:");
		...
		int nota = sc.nextInt();
		   ...
		   // 0! = 1, 1! = 1, 2! = 2 * 1, 3! = 3 * 2* 1, N! = N * (N-1) * (N-2)........* 3*2*1
		 ...
		 //9. Escribe un programa que recibe como datos de entrada una hora expresada en horas, minutos y segundos que nos calcula 
	...
	//12. Realiza un programa que lea una secuencia de números no nulos hasta que se introduzca un 0, 
